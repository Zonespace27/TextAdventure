...
class ComponentChair(Component):
    ...
    def __init__(self, args_dict = dict[str]) -> None:
        ...
        self.sit_down_message: str = self.arg_set(args_dict, "sit_down_message", str) or "You sit down in the chair."
        # The message to send to the user when getting up
        self.get_up_message: str = self.arg_set(args_dict, "get_up_message", str) or "You get up from the chair."
    ...
    def on_sit(self, source):
        ...
        globals.player_ref.add_component(ComponentSittingDown, {"get_up_message": self.get_up_message})
