...
from events import EVENT_BASEOBJ_PRINT_DESCRIPTION, EVENT_RETVAL_BLOCK_BASEOBJ_PRINT_DESCRIPTION, EVENT_RETVAL_BLOCK_ALL_PRINT_DESCRIPTION
import globals
...
class ComponentFirstEnterMessage(Component):
    ...
    def attach_to_parent(self, object_to_attach: BaseObj) -> bool:
        ...
        self.register_event(object_to_attach, EVENT_BASEOBJ_PRINT_DESCRIPTION, self.send_message)
