...
from events import EVENT_VERB_OPEN_CONTAINER, EVENT_BASEOBJ_PRINT_DESCRIPTION, EVENT_RETVAL_BLOCK_BASEOBJ_PRINT_DESCRIPTION, EVENT_PLAYER_FIND_CONTENTS, EVENT_VERB_CLOSE_CONTAINER, EVENT_VERB_EXAMINE
